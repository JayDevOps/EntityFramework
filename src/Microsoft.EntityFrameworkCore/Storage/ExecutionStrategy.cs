...
namespace Microsoft.EntityFrameworkCore.Storage
{
    ...
    public abstract class ExecutionStrategy : IExecutionStrategy
    {
        ...
        /// <summary>
        ///     Indicates whether the strategy performs any additional actions when executing an operation
        /// </summary>
            ...
            CancellationToken cancellationToken = new CancellationToken())
        {
            ...
            return ExecuteAsyncImplementation(operation, state, cancellationToken);
        }
        ...
        protected virtual void OnFirstExecution()
        {
            ...
            {
                throw new InvalidOperationException(CoreStrings.ExecutionStrategyExistingTransaction(GetType().Name));
            }
